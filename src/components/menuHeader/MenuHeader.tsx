...
const MenuHeader = () => {
    ...
    return (
        <div style={{backgroundColor: "#282826"}}>
            <div id="panelMenuContainer" className={`container ${classes.headerWrapper}`}>
            ...
            >
                <div className={`container ${classes.panelMenuHeader}`} style={{visibility: isElement ? "visible" : "hidden"}}>
                    ...
                    <div className={classes.imageContainer}>
                        <ImageMenu image={womenDressesImage} text={"Spring 2024"}></ImageMenu>
                        <ImageMenu image={womenSpringImage} text={"Spring 2024"}></ImageMenu>
                    </div>
                </div>
            </div>
        </div>
